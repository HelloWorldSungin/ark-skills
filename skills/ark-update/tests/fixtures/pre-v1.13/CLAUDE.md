...
A minimal project at pre-v1.13 state. Has v1.11+v1.12 conventions
(setup-vault-symlink.sh exists, routing-rules block present at v1.12.0).
Missing OMC routing block and .ark-workflow/ gitignore entry.
