...
*Note: `/ralph` is a suitable autopilot variant when the success criterion is a measurable benchmark (loop-to-verified). Handback contract: `references/omc-integration.md` § Section 4.2.*
